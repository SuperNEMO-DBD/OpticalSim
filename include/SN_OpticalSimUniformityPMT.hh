...
private:
  UniformityPMT() {
    //TFile *file = new TFile("/home/local1/Optical_Simulation_Arnaud/simulation_input_files/AU_GA0494_TH2.root");
    //Histo = (TH2F*) file->Get("UniformityPM");

    TFile *file = new TFile("/nemo243/Optical_Simulation_Arnaud/simulation_input_files/Mean_AU.root");
    //TFile *file = new TFile("/nemo243/Optical_Simulation_Arnaud/simulation_input_files/Anode_Uniformity/AU_GA0494_TH2.root");
