...
{  
  ...
  hist->SetPoint(23, 20, 135, 0.98);    //Z-2 -
  hist->SetPoint(24, 20, 90, 1.00);      //Y +
  hist->SetPoint(25, 20, 45, 1.00);     //Z-1 +
  ...
  hist->SetPoint(37, 40, 315, 0.88);    //Z-2 +
  ...
  hist->SetPoint(55, 60, 315, 0.82);    //Z-2 +
  ...
  hist->SetPoint(61, 60, 45, 0.82);     //Z-1 +

  hist->SetPoint(62, 70, 0, 0.70);      //X +
  hist->SetPoint(63, 70, 360, 0.70);      //X +
  hist->SetPoint(64, 70, 315, 0.78);    //Z-2 +
  hist->SetPoint(65, 70, 270, 0.56);     //Y -
  hist->SetPoint(66, 70, 225, 0.68);   //Z-1 -
  hist->SetPoint(67, 70, 180, 0.64);     //X -
  hist->SetPoint(68, 70, 135, 0.54);    //Z-2 -
  hist->SetPoint(69, 70, 90, 0.60);      //Y +
  hist->SetPoint(70, 70, 45, 0.64);     //Z-1 +

  hist->SetPoint(71, 80, 0, 0.63);      //X +
  hist->SetPoint(72, 80, 360, 0.63);      //X +
  ...
  hist->SetPoint(77, 80, 135, 0.24);    //Z-2 -
  ...
  TCanvas * canvas8 = new TCanvas("canvas8", "AU GA0556 ",0,0, 600, 400);
  canvas8->cd();
  hist->Draw("colz");
  ...
  TH2D* dummy_his = new TH2D("dummy", "GA0556", 100, -100, 100, 100, -100, 100);

  TCanvas * canvas7 = new TCanvas("GA0556", "AU GA0556",0,0, 1000, 1000);
   canvas7->cd();
   //AU->Draw("colz");
   dummy_his->Draw();
   ...
   // TFile f("AU_GA0556_TH2.root", "recreate");
   // AU->Write();
