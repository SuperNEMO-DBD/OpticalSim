...
{  
  ...
  hist->SetPoint(14, 10, 135, 0.96);    //Z-2 -
  hist->SetPoint(15, 10, 90, 0.96);      //Y +
  hist->SetPoint(16, 10, 45, 0.96);     //Z-1 +
  ...
  hist->SetPoint(22, 20, 180, 0.90);     //X -
  hist->SetPoint(23, 20, 135, 0.88);    //Z-2 -
  ...
  hist->SetPoint(32, 30, 135, 0.80);    //Z-2 -
  hist->SetPoint(33, 30, 90, 0.70);      //Y +
  hist->SetPoint(34, 30, 45, 0.78);     //Z-1 +
  ...
  hist->SetPoint(51, 50, 90, 0.70);      //Y +
  hist->SetPoint(52, 50, 45, 0.78);     //Z-1 +

  hist->SetPoint(53, 60, 0, 0.78);      //X +
  hist->SetPoint(54, 60, 360, 0.78);      //X +
  hist->SetPoint(55, 60, 315, 0.78);    //Z-2 +
  hist->SetPoint(56, 60, 270, 0.78);     //Y -
  hist->SetPoint(57, 60, 225, 0.80);   //Z-1 -
  hist->SetPoint(58, 60, 180, 0.74);     //X -
  hist->SetPoint(59, 60, 135, 0.74);    //Z-2 -
  hist->SetPoint(60, 60, 90, 0.64);      //Y +
  hist->SetPoint(61, 60, 45, 0.70);     //Z-1 +

  hist->SetPoint(62, 70, 0, 0.74);      //X +
  hist->SetPoint(63, 70, 360, 0.74);      //X +
  hist->SetPoint(64, 70, 315, 0.73);    //Z-2 +
  hist->SetPoint(65, 70, 270, 0.55);     //Y -
  hist->SetPoint(66, 70, 225, 0.78);   //Z-1 -
  hist->SetPoint(67, 70, 180, 0.66);     //X -
  hist->SetPoint(68, 70, 135, 0.50);    //Z-2 -
  hist->SetPoint(69, 70, 90, 0.52);      //Y +
  hist->SetPoint(70, 70, 45, 0.54);     //Z-1 +

  hist->SetPoint(71, 80, 0, 0.54);      //X +
  hist->SetPoint(72, 80, 360, 0.54);      //X +
  hist->SetPoint(73, 80, 315, 0.16);    //Z-2 +
  hist->SetPoint(74, 80, 270, 0.14);     //Y -
  hist->SetPoint(75, 80, 225, 0.62);   //Z-1 -
  hist->SetPoint(76, 80, 180, 0.50);     //X -
  hist->SetPoint(77, 80, 135, 0.22);    //Z-2 -
  hist->SetPoint(78, 80, 90, 0.16);      //Y +
  ...
  TCanvas * canvas8 = new TCanvas("canvas8", "AU GA0569 ",0,0, 600, 400);
  canvas8->cd();
  hist->Draw("colz");
  ...
  TH2D* dummy_his = new TH2D("dummy", "GA0569", 100, -100, 100, 100, -100, 100);

  TCanvas * canvas7 = new TCanvas("GA0559", "AU GA0559",0,0, 1000, 1000);
   canvas7->cd();
   //AU->Draw("colz");
   dummy_his->Draw();
   ...
   // TFile f("AU_GA0569_TH2.root", "recreate");
   // AU->Write();
