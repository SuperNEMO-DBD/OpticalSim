...
{  
  ...
  hist->SetPoint(51, 50, 90, 0.74);      //Y +
  hist->SetPoint(52, 50, 45, 0.86);     //Z-1 +

  hist->SetPoint(53, 60, 0, 0.76);      //X +
  hist->SetPoint(54, 60, 360, 0.76);      //X +
  hist->SetPoint(55, 60, 315, 0.86);    //Z-2 +
  hist->SetPoint(56, 60, 270, 0.82);     //Y -
  hist->SetPoint(57, 60, 225, 0.80);   //Z-1 -
  hist->SetPoint(58, 60, 180, 0.80);     //X -
  hist->SetPoint(59, 60, 135, 0.84);    //Z-2 -
  hist->SetPoint(60, 60, 90, 0.80);      //Y +
  hist->SetPoint(61, 60, 45, 0.84);     //Z-1 +

  hist->SetPoint(62, 70, 0, 0.66);      //X +
  hist->SetPoint(63, 70, 360, 0.66);      //X +
  hist->SetPoint(64, 70, 315, 0.59);    //Z-2 +
  hist->SetPoint(65, 70, 270, 0.72);     //Y -
  hist->SetPoint(66, 70, 225, 0.76);   //Z-1 -
  hist->SetPoint(67, 70, 180, 0.77);     //X -
  hist->SetPoint(68, 70, 135, 0.72);    //Z-2 -
  hist->SetPoint(69, 70, 90, 0.60);      //Y +
  hist->SetPoint(70, 70, 45, 0.66);     //Z-1 +

  hist->SetPoint(71, 80, 0, 0.31);      //X +
  hist->SetPoint(72, 80, 360, 0.31);      //X +
  hist->SetPoint(73, 80, 315, 0.20);    //Z-2 +
  hist->SetPoint(74, 80, 270, 0.16);     //Y -
  hist->SetPoint(75, 80, 225, 0.26);   //Z-1 -
  hist->SetPoint(76, 80, 180, 0.62);     //X -
  hist->SetPoint(77, 80, 135, 0.26);    //Z-2 -
  ...
  TCanvas * canvas8 = new TCanvas("canvas8", "AU GA0463 ",0,0, 600, 400);
  canvas8->cd();
  hist->Draw("colz");
  ...
  TH2D* dummy_his = new TH2D("dummy", "GA0463", 100, -100, 100, 100, -100, 100);

  TCanvas * canvas7 = new TCanvas("GA0463", "AU GA0463",0,0, 1000, 1000);
   canvas7->cd();
   //AU->Draw("colz");
   dummy_his->Draw();
   ...
   // TFile f("AU_GA0463_TH2.root", "recreate");
   // AU->Write();
