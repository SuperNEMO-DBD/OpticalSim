...
{  
  ...
  hist->SetPoint(11, 10, 270, 0.94);     //Y -
  ...
  hist->SetPoint(33, 30, 90, 0.86);      //Y +
  hist->SetPoint(34, 30, 45, 0.98);     //Z-1 +

  hist->SetPoint(35, 40, 0, 0.88);      //X +
  hist->SetPoint(36, 40, 360, 0.88);      //X +
  hist->SetPoint(37, 40, 315, 0.92);    //Z-2 +
  hist->SetPoint(38, 40, 270, 0.86);     //Y -
  ...
  hist->SetPoint(46, 50, 315, 0.94);    //Z-2 +
  ...
  hist->SetPoint(55, 60, 315, 0.92);    //Z-2 +
  hist->SetPoint(56, 60, 270, 0.86);     //Y -
  hist->SetPoint(57, 60, 225, 0.74);   //Z-1 -
  hist->SetPoint(58, 60, 180, 0.72);     //X -
  hist->SetPoint(59, 60, 135, 0.82);    //Z-2 -
  hist->SetPoint(60, 60, 90, 0.76);      //Y +
  hist->SetPoint(61, 60, 45, 0.78);     //Z-1 +

  hist->SetPoint(62, 70, 0, 0.66);      //X +
  hist->SetPoint(63, 70, 360, 0.66);      //X +
  hist->SetPoint(64, 70, 315, 0.52);    //Z-2 +
  hist->SetPoint(65, 70, 270, 0.54);     //Y -
  hist->SetPoint(66, 70, 225, 0.74);   //Z-1 -
  hist->SetPoint(67, 70, 180, 0.64);     //X -
  hist->SetPoint(68, 70, 135, 0.56);    //Z-2 -
  hist->SetPoint(69, 70, 90, 0.56);      //Y +
  hist->SetPoint(70, 70, 45, 0.54);     //Z-1 +

  hist->SetPoint(71, 80, 0, 0.60);      //X +
  hist->SetPoint(72, 80, 360, 0.60);      //X +
  hist->SetPoint(73, 80, 315, 0.08);    //Z-2 +
  ...
  hist->SetPoint(79, 80, 45, 0.32);     //Z-1 +
  ...
  TCanvas * canvas8 = new TCanvas("canvas8", "AU GA0365 ",0,0, 600, 400);
  canvas8->cd();
  hist->Draw("colz");
  ...
  TH2D* dummy_his = new TH2D("dummy", "GA0365", 100, -100, 100, 100, -100, 100);

   TCanvas * canvas7 = new TCanvas("GA0365", "AU GA0365 ",0,0, 1000, 1000);
   canvas7->cd();
   //AU->Draw("colz");
   dummy_his->Draw();
   ...
   // TFile f("AU_GA0365_TH2.root", "recreate");
   // AU->Write();
