...
{  
  ...
  hist->SetPoint(23, 20, 135, 0.85);    //Z-2 -
  hist->SetPoint(24, 20, 90, 0.86);      //Y +
  hist->SetPoint(25, 20, 45, 0.94);     //Z-1 +

  hist->SetPoint(26, 30, 0, 0.90);      //X +
  hist->SetPoint(27, 30, 360, 0.90);      //X +
  hist->SetPoint(28, 30, 315, 0.85);    //Z-2 +
  hist->SetPoint(29, 30, 270, 0.76);     //Y -
  hist->SetPoint(30, 30, 225, 0.80);   //Z-1 -
  hist->SetPoint(31, 30, 180, 0.80);     //X -
  hist->SetPoint(32, 30, 135, 0.76);    //Z-2 -
  hist->SetPoint(33, 30, 90, 0.72);      //Y +
  hist->SetPoint(34, 30, 45, 0.80);     //Z-1 +

  hist->SetPoint(35, 40, 0, 0.86);      //X +
  hist->SetPoint(36, 40, 360, 0.86);      //X +
  hist->SetPoint(37, 40, 315, 0.74);    //Z-2 +
  hist->SetPoint(38, 40, 270, 0.76);     //Y -
  hist->SetPoint(39, 40, 225, 0.78);   //Z-1 -
  hist->SetPoint(40, 40, 180, 0.72);     //X -
  hist->SetPoint(41, 40, 135, 0.72);    //Z-2 -
  hist->SetPoint(42, 40, 90, 0.64);      //Y +
  ...
  hist->SetPoint(47, 50, 270, 0.78);     //Y -
  hist->SetPoint(48, 50, 225, 0.76);   //Z-1 -
  hist->SetPoint(49, 50, 180, 0.70);     //X -
  hist->SetPoint(50, 50, 135, 0.70);    //Z-2 -
  hist->SetPoint(51, 50, 90, 0.60);      //Y +
  ...
  TCanvas * canvas8 = new TCanvas("canvas8", "AU GA0154 ",0,0, 600, 400);
  canvas8->cd();
  hist->Draw("colz");
  ...
  TH2D* dummy_his = new TH2D("dummy", "GA0154", 100, -100, 100, 100, -100, 100);

   TCanvas * canvas7 = new TCanvas("GA0154", "AU GA0154 ",0,0, 1000, 1000);
   canvas7->cd();
   //AU->Draw("colz");
   dummy_his->Draw();
