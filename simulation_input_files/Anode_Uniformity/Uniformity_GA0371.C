...
{  
  ...
  hist->SetPoint(8, 10, 0, 0.98);      //X +
  hist->SetPoint(9, 10, 360, 0.98);      //X +
  hist->SetPoint(10, 10, 315, 0.96);    //Z-2 +
  hist->SetPoint(11, 10, 270, 0.98);     //Y -
  hist->SetPoint(12, 10, 225, 1.00);   //Z-1 -
  hist->SetPoint(13, 10, 180, 0.98);     //X -
  ...
  hist->SetPoint(40, 40, 180, 0.88);     //X -
  hist->SetPoint(41, 40, 135, 0.90);    //Z-2 -
  hist->SetPoint(42, 40, 90, 0.88);      //Y +
  hist->SetPoint(43, 40, 45, 0.88);     //Z-1 +

  hist->SetPoint(44, 50, 0, 0.83);      //X +
  hist->SetPoint(45, 50, 360, 0.83);      //X +
  hist->SetPoint(46, 50, 315, 0.82);    //Z-2 +
  hist->SetPoint(47, 50, 270, 0.92);     //Y -
  hist->SetPoint(48, 50, 225, 0.91);   //Z-1 -
  hist->SetPoint(49, 50, 180, 0.84);     //X -
  hist->SetPoint(50, 50, 135, 0.90);    //Z-2 -
  hist->SetPoint(51, 50, 90, 0.88);      //Y +
  hist->SetPoint(52, 50, 45, 0.84);     //Z-1 +

  hist->SetPoint(53, 60, 0, 0.72);      //X +
  hist->SetPoint(54, 60, 360, 0.72);      //X +
  hist->SetPoint(55, 60, 315, 0.88);    //Z-2 +
  hist->SetPoint(56, 60, 270, 0.92);     //Y -
  hist->SetPoint(57, 60, 225, 0.92);   //Z-1 -
  hist->SetPoint(58, 60, 180, 0.80);     //X -
  hist->SetPoint(59, 60, 135, 0.90);    //Z-2 -
  hist->SetPoint(60, 60, 90, 0.90);      //Y +
  hist->SetPoint(61, 60, 45, 0.81);     //Z-1 +

  hist->SetPoint(62, 70, 0, 0.61);      //X +
  hist->SetPoint(63, 70, 360, 0.61);      //X +
  hist->SetPoint(64, 70, 315, 0.61);    //Z-2 +
  hist->SetPoint(65, 70, 270, 0.78);     //Y -
  hist->SetPoint(66, 70, 225, 0.82);   //Z-1 -
  hist->SetPoint(67, 70, 180, 0.69);     //X -
  hist->SetPoint(68, 70, 135, 0.74);    //Z-2 -
  hist->SetPoint(69, 70, 90, 0.57);      //Y +
  hist->SetPoint(70, 70, 45, 0.56);     //Z-1 +

  hist->SetPoint(71, 80, 0, 0.41);      //X +
  hist->SetPoint(72, 80, 360, 0.41);      //X +
  hist->SetPoint(73, 80, 315, 0.16);    //Z-2 +
  hist->SetPoint(74, 80, 270, 0.16);     //Y -
  hist->SetPoint(75, 80, 225, 0.30);   //Z-1 -
  hist->SetPoint(76, 80, 180, 0.57);     //X -
  hist->SetPoint(77, 80, 135, 0.22);    //Z-2 -
  ...
  TCanvas * canvas8 = new TCanvas("canvas8", "AU GA0371 ",0,0, 600, 400);
  canvas8->cd();
  hist->Draw("colz");
  ...
  TH2D* dummy_his = new TH2D("dummy", "GA0371", 100, -100, 100, 100, -100, 100);

  TCanvas * canvas7 = new TCanvas("GA0371", "AU GA0371",0,0, 1000, 1000);
   canvas7->cd();
   //AU->Draw("colz");
   dummy_his->Draw();
   ...
   // TFile f("AU_GA0371_TH2.root", "recreate");
   // AU->Write();
