...
{  
  ...
  hist->SetPoint(11, 10, 270, 1.00);     //Y -
  ...
  hist->SetPoint(32, 30, 135, 0.84);    //Z-2 -
  hist->SetPoint(33, 30, 90, 0.92);      //Y +
  hist->SetPoint(34, 30, 45, 0.88);     //Z-1 +

  hist->SetPoint(35, 40, 0, 0.80);      //X +
  hist->SetPoint(36, 40, 360, 0.80);      //X +
  hist->SetPoint(37, 40, 315, 0.74);    //Z-2 +
  hist->SetPoint(38, 40, 270, 0.90);     //Y -
  hist->SetPoint(39, 40, 225, 0.82);   //Z-1 -
  hist->SetPoint(40, 40, 180, 0.78);     //X -
  hist->SetPoint(41, 40, 135, 0.70);    //Z-2 -
  hist->SetPoint(42, 40, 90, 0.84);      //Y +
  hist->SetPoint(43, 40, 45, 0.78);     //Z-1 +

  hist->SetPoint(44, 50, 0, 0.72);      //X +
  hist->SetPoint(45, 50, 360, 0.72);      //X +
  ...
  hist->SetPoint(51, 50, 90, 0.78);      //Y +
  hist->SetPoint(52, 50, 45, 0.74);     //Z-1 +

  hist->SetPoint(53, 60, 0, 0.64);      //X +
  hist->SetPoint(54, 60, 360, 0.64);      //X +
  hist->SetPoint(55, 60, 315, 0.78);    //Z-2 +
  hist->SetPoint(56, 60, 270, 0.84);     //Y -
  hist->SetPoint(57, 60, 225, 0.84);   //Z-1 -
  hist->SetPoint(58, 60, 180, 0.64);     //X -
  hist->SetPoint(59, 60, 135, 0.74);    //Z-2 -
  hist->SetPoint(60, 60, 90, 0.82);      //Y +
  hist->SetPoint(61, 60, 45, 0.76);     //Z-1 +

  hist->SetPoint(62, 70, 0, 0.58);      //X +
  hist->SetPoint(63, 70, 360, 0.58);      //X +
  hist->SetPoint(64, 70, 315, 0.72);    //Z-2 +
  hist->SetPoint(65, 70, 270, 0.54);     //Y -
  hist->SetPoint(66, 70, 225, 0.56);   //Z-1 -
  hist->SetPoint(67, 70, 180, 0.56);     //X -
  hist->SetPoint(68, 70, 135, 0.54);    //Z-2 -
  hist->SetPoint(69, 70, 90, 0.54);      //Y +
  hist->SetPoint(70, 70, 45, 0.52);     //Z-1 +

  hist->SetPoint(71, 80, 0, 0.52);      //X +
  hist->SetPoint(72, 80, 360, 0.52);      //X +
  hist->SetPoint(73, 80, 315, 0.22);    //Z-2 +
  hist->SetPoint(74, 80, 270, 0.16);     //Y -
  hist->SetPoint(75, 80, 225, 0.16);   //Z-1 -
  hist->SetPoint(76, 80, 180, 0.56);     //X -
  hist->SetPoint(77, 80, 135, 0.20);    //Z-2 -
  hist->SetPoint(78, 80, 90, 0.14);      //Y +
  hist->SetPoint(79, 80, 45, 0.12);     //Z-1 +
  ...
  TCanvas * canvas8 = new TCanvas("canvas8", "AU GA0245 ",0,0, 600, 400);
  canvas8->cd();
  hist->Draw("colz");
  ...
  TH2D* dummy_his = new TH2D("dummy", "GA0245", 100, -100, 100, 100, -100, 100);

   TCanvas * canvas7 = new TCanvas("GA0245", "AU GA0245 ",0,0, 1000, 1000);
   canvas7->cd();
   //AU->Draw("colz");
   dummy_his->Draw();
   ...
   AU->SetMinimum(0);
   AU->SetMaximum(1);
   // TFile f("AU_GA0245_TH2.root", "recreate");
   // AU->Write();
