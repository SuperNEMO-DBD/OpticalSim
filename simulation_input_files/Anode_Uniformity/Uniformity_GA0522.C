...
{  
  ...
  hist->SetPoint(12, 10, 225, 0.98);   //Z-1 -
  hist->SetPoint(13, 10, 180, 0.98);     //X -
  hist->SetPoint(14, 10, 135, 1.00);    //Z-2 -
  hist->SetPoint(15, 10, 90, 0.98);      //Y +
  hist->SetPoint(16, 10, 45, 1.00);     //Z-1 +

  hist->SetPoint(17, 20, 0, 1.00);      //X +
  hist->SetPoint(18, 20, 360, 1.00);      //X +
  hist->SetPoint(19, 20, 315, 0.98);    //Z-2 +
  hist->SetPoint(20, 2, 270, 0.98);     //Y -
  hist->SetPoint(21, 20, 225, 0.94);   //Z-1 -
  ...
  hist->SetPoint(37, 40, 315, 0.86);    //Z-2 +
  hist->SetPoint(38, 40, 270, 0.92);     //Y -
  hist->SetPoint(39, 40, 225, 0.88);   //Z-1 -
  hist->SetPoint(40, 40, 180, 0.84);     //X -
  hist->SetPoint(41, 40, 135, 0.84);    //Z-2 -
  ...
  hist->SetPoint(48, 50, 225, 0.80);   //Z-1 -
  hist->SetPoint(49, 50, 180, 0.82);     //X -
  hist->SetPoint(50, 50, 135, 0.82);    //Z-2 -
  ...
  hist->SetPoint(57, 60, 225, 0.78);   //Z-1 -
  hist->SetPoint(58, 60, 180, 0.74);     //X -
  hist->SetPoint(59, 60, 135, 0.76);    //Z-2 -
  hist->SetPoint(60, 60, 90, 0.74);      //Y +
  hist->SetPoint(61, 60, 45, 0.76);     //Z-1 +

  hist->SetPoint(62, 70, 0, 0.62);      //X +
  hist->SetPoint(63, 70, 360, 0.62);      //X +
  hist->SetPoint(64, 70, 315, 0.74);    //Z-2 +
  hist->SetPoint(65, 70, 270, 0.60);     //Y -
  hist->SetPoint(66, 70, 225, 0.74);   //Z-1 -
  hist->SetPoint(67, 70, 180, 0.60);     //X -
  hist->SetPoint(68, 70, 135, 0.57);    //Z-2 -
  hist->SetPoint(69, 70, 90, 0.56);      //Y +
  hist->SetPoint(70, 70, 45, 0.56);     //Z-1 +

  hist->SetPoint(71, 80, 0, 0.40);      //X +
  hist->SetPoint(72, 80, 360, 0.40);      //X +
  hist->SetPoint(73, 80, 315, 0.30);    //Z-2 +
  ...
  TCanvas * canvas8 = new TCanvas("canvas8", "AU GA0522 ",0,0, 600, 400);
  canvas8->cd();
  hist->Draw("colz");
  ...
  TH2D* dummy_his = new TH2D("dummy", "GA0522", 100, -100, 100, 100, -100, 100);

  TCanvas * canvas7 = new TCanvas("GA0522", "AU GA0522",0,0, 1000, 1000);
   canvas7->cd();
   //AU->Draw("colz");
   dummy_his->Draw();
   ...
   // TFile f("AU_GA0522_TH2.root", "recreate");
   // AU->Write();
