...
G4VPhysicalVolume* SN_OpticalSimGeometry::Construct( ){
  ...
  G4String PMTfile = "/data/nemo243/Simulation_Optique/simulation_input_files/QE_ham_GA0192.txt"; //File for 8 inches !!!
  ...
  if (ReadPMT.is_open()){
    while(!ReadPMT.eof()){
      ...
      PMTdetect[PMTentries] = quant_eff*.57;  //For the GAxxxx file with good QE and 0.65 for collection efficiency
