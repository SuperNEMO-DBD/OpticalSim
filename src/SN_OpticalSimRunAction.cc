...
void SN_OpticalSimRunAction::BeginOfRunAction(const G4Run* aRun){
  ...
  //f = new TFile(fileName,"UPDATE");
    ...
    RunBranch = theRunTree->Branch("Optical_Information",&Stats.IncidentE,"IncidentE/F:Deposit/F:Generated/I:Absorbed:BulkAbs:Escaped:Failed:Transmitted:Detected_without_CU:Lost:WLS:Detected:FWHM/F:FWHM_Final/F:Frac_Detected/F:Frac_Transmitted/F:Total_Track_Length_e/F:Count_Scintillation/F:Count_Cerenkov/F");
    ...
    RunBranch = theRunTree_ter->Branch("Timing_Information",&Statster.TotTrackLen,"TotTrackLen/F:TimeTransSc/F:TimeEmissionScPTP/F:TimeEmissionScPOPOP/F:TimeEmissionSc/F:TimeTotalSc/F:TimeTransitPMT/F:TimeTotal/F:DeathLambda/F:G4_Time_Sc/F:G4_Time_Total/F:Reflections/I");
    ...
    RunBranch = Tree_deposited->Branch("Energy_Deposited",&Statsdeposited.EdepTotal,"E_deposit_Total/F:E_deposit_Total_Corrected/F:E_deposit_Coinc/F:E_deposit_Elec/F:E_deposit_Gamma/F:E_deposit_Conv/F:E_deposit_Alpha/F:E_deposit_Total_FALAISE/F:E_deposit_Total_FALAISE_Position_Corrected/F:E_deposit_Total_FALAISE_Position_Resolution_Corrected/F:E_deposit_Total_FALAISE_Corrected/F:E_deposit_Total_Optical_Corrected/F:True_Energy_Deposit/F:Position_x/F:Position_y/F:Position_z/F:Number_Interaction/I:Coinc/O");
